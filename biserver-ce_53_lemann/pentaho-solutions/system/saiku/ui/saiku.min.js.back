...
(c._options.batchSize=1E3);a=c.internalRender(c._data,c._options);$(c._options.htmlObject).html(a);_.defer(function(a){if(c._options.hasOwnProperty("batch")&&c._options.hasBatchResult){var b=0,d=!1,l=c._options.hasOwnProperty("batchIntervalSize")?c._options.batchIntervalSize:20;a=c._options.hasOwnProperty("batchIntervalTime")?c._options.batchIntervalTime:20;var h=c._options.batchResult.length,k=_.debounce(function(){if(!d&&0<h&&b<h){d=!0;for(var a="",e=b,k=0;b<h&&k<l;k++,b++)a+=c._options.batchResult[b];
b>e&&$(c._options.htmlObject).append($(a));d=!1}b>=h&&$(c._options.htmlObject).parent().parent().unbind("scroll")},a);$(c._options.htmlObject).parent().parent().scroll(function(){k()})}});return a});else return this.internalRender(this._data,c._options)};SaikuTableRenderer.prototype.clear=function(a,b){this._options.htmlObject&&this._options.hasOwnProperty("batch")&&$(this._options.htmlObject).parent().parent().unbind("scroll")};
SaikuTableRenderer.prototype._processData=function(a,b){this._hasProcessed=!0};function genTotalDataCells(a,b,c,d,e){var f="";e=e[ROWS];for(var g=c.length-1;0<=g;g--)if(a==c[g]){for(var l=e[g][d[g]],h=0;h<l.cells.length;h++)f+='\x3ctd class\x3d"data total"\x3e'+l.cells[h][b].value+"\x3c/td\x3e";d[g]++;d[g]<e[g].length&&(c[g]+=e[g][d[g]].width)}return f}
function genTotalHeaderCells(a,b,c,d,e){for(var f="",g=b;0<=g;g--)if(a==c[g]){var l=e[g][d[g]],h;h=0===g&&1==b?"col":g==b?"col_total_corner":g==b-1&&l.captions?"col_total_first":"col_null";for(var k=0;k<l.cells.length;k++){var s="\x26nbsp;";b==e.length-1&&(l.captions&&(s=e[g][d[g]].captions[k]),0===g&&0===d[g]&&(s=l.captions?s+"\x3cspan class\x3d'i18n'\x3e Grand Total\x3c/span\x3e":"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e"));f+='\x3cth class\x3d"'+h+'"\x3e\x3cdiv\x3e'+s+"\x3c/div\x3e\x3c/th\x3e"}d[g]++;
...
function genTotalHeaderRowCells(a,b,c,d){for(var e=d[COLUMNS],f=b[COLUMNS],g=c[COLUMNS],l=e.length-2,h="",k=l;0<=k;k--)if(a==f[k]){for(var s=0;s<e[k][g[k]].cells.length;s++){h+="\x3ctr\x3e";for(b=0;b<=l;b++){var m="\x26nbsp;";c=0===k&&0===b?"row":k==b+1?"row_total_corner":k==b&&e[k][g[k]].captions?"row_total_first":k<b+1?"row_total":"row_null";b==l&&(e[k][g[k]].captions&&(m=e[k][g[k]].captions[s]),0===k&&0===g[k]&&(m=e[k][g[k]].captions?m+"\x3cspan class\x3d'i18n'\x3e Grand Total\x3c/span\x3e":"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e"));
h+='\x3cth class\x3d"'+c+'"\x3e\x3cdiv\x3e'+m+"\x3c/div\x3e\x3c/th\x3e"}c={};b={};for(m=0;m<d[ROWS].length;m++)c[m]=0,b[m]=d[ROWS][m][c[m]].width;for(m=0;m<e[k][g[k]].cells[s].length;m++)h+='\x3ctd class\x3d"data total"\x3e'+e[k][g[k]].cells[s][m].value+"\x3c/td\x3e",h+=totalIntersectionCells(m+1,d[ROWS].length-1,b,c,d[ROWS]);h+="\x3c/tr\x3e"}g[k]++;g[k]<e[k].length&&(f[k]+=e[k][g[k]].width)}return h}var ROWS="ROWS",COLUMNS="COLUMNS";
...
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f=e?e:[],g,l,h,k,s,m=0,A=[],q=null,y=!1,v=[];b&&(q=b.hasOwnProperty("batchSize")?b.batchSize:null);var r={};r[COLUMNS]=a.rowTotalsLists;r[ROWS]=a.colTotalsLists;for(var u={},z={},n=[ROWS,COLUMNS],w,d=0;d<n.length;d++)u[n[d]]=[],z[n[d]]=[];if(r[COLUMNS])for(d=0;d<r[COLUMNS].length;d++)z[COLUMNS][d]=0,u[COLUMNS][d]=r[COLUMNS][d][z[COLUMNS][d]].width;for(var n=0,F=f.length;n<F;n++){var x=n-a.topOffset;g=1;var D=k=l=!1;
if(r[ROWS])for(d=0;d<r[ROWS].length;d++)z[ROWS][d]=0,u[ROWS][d]=r[ROWS][d][z[ROWS][d]].width;for(var d="\x3ctr\x3e",t=0,G=f[n].length;t<G;t++){var E=t-a.leftOffset,p=e[n][t];if("COLUMN_HEADER"===p.type&&"null"===p.value&&(null===h||t<h))d+='\x3cth class\x3d"all_null"\x3e\x3cdiv\x3e\x26nbsp;\x3c/div\x3e\x3c/th\x3e';else if("COLUMN_HEADER"===p.type){null===h&&(h=t);f[n].length==t+1?k=!0:s=e[n][t+1];if(k)"null"==p.value?d+='\x3cth class\x3d"col_null"\x3e\x3cdiv\x3e\x26nbsp;\x3c/div\x3e\x3c/th\x3e':(r[ROWS]&&
(g=r[ROWS][n+1][z[ROWS][n+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+p.value+'"\x3e\x3cdiv rel\x3d"'+n+":"+t+'"\x3e'+p.value+"\x3c/div\x3e\x3c/th\x3e");else{var E=1<t&&1<n&&!l&&t>h?e[n-1][t+1].value!=e[n-1][t].value||e[n-1][t+1].properties.uniquename!=e[n-1][t].properties.uniquename:!1,B=999<g?!0:!1;p.value!=s.value||nextParentsDiffer(e,n,t)||l||E||B?("null"==p.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x3cdiv\x3e\x26nbsp;\x3c/div\x3e\x3c/th\x3e':
(r[ROWS]&&(g=r[ROWS][n+1][z[ROWS][n+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0===g?1:g)+'" title\x3d"'+p.value+'"\x3e\x3cdiv rel\x3d"'+n+":"+t+'"\x3e'+p.value+"\x3c/div\x3e\x3c/th\x3e"),g=1):g++}r[ROWS]&&(d+=genTotalHeaderCells(t-a.leftOffset+1,n+1,u[ROWS],z[ROWS],r[ROWS]))}else if("ROW_HEADER"===p.type&&"null"===p.value)d+='\x3cth class\x3d"row_null"\x3e\x3cdiv\x3e\x26nbsp;\x3c/div\x3e\x3c/th\x3e';else if("ROW_HEADER"===p.type){m==t?l=!0:s=e[n][t+1];var E=
e[n-1],B=!D&&!l&&(0===t||!topParentsDiffer(e,n,t))&&p.value===E[t].value,D=!B,E=B?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+n+":"+t+'"\x3e'+p.value+"\x3c/div\x3e",B=B?"row_null":"row",C=0;if(!l&&("undefined"==typeof s||"null"===s.value)){C=1;w=p.properties.dimension;p=p.properties.level;p=w in A?A[w].length-A[w].indexOf(p):1;for(w=t+1;C<p&&w<=m+1&&"null"!==e[n][w];w++)C=w-t;t=t+C-1}d+='\x3cth class\x3d"'+B+'" '+(0<C?' colspan\x3d"'+C+'"':"")+"\x3e"+E+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===
p.type)d+='\x3cth class\x3d"row_header"\x3e\x3cdiv\x3e'+p.value+"\x3c/div\x3e\x3c/th\x3e",l=!0,m=t,p.properties.hasOwnProperty("dimension")&&(w=p.properties.dimension,w in A||(A[w]=[]),A[w].push(p.properties.level));else if("DATA_CELL"===p.type){y=!0;B="";w=p.value;C="";if(p.properties.hasOwnProperty("image")){w=p.properties.hasOwnProperty("image_height")?" height\x3d'"+p.properties.image_height+"'":"";var H=p.properties.hasOwnProperty("image_width")?" width\x3d'"+p.properties.image_width+"'":"";
w="\x3cimg "+w+" "+H+" style\x3d'padding-left: 5px' src\x3d'"+p.properties.image+"' border\x3d'0'\x3e"}p.properties.hasOwnProperty("style")&&(B=" style\x3d'background-color: "+p.properties.style+"' ");p.properties.hasOwnProperty("link")&&(w="\x3ca target\x3d'__blank' href\x3d'"+p.properties.link+"'\x3e"+w+"\x3c/a\x3e");p.properties.hasOwnProperty("arrow")&&(C="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+p.properties.arrow+".gif' border\x3d'0'\x3e");d+=
'\x3ctd class\x3d"data" '+B+'\x3e\x3cdiv alt\x3d"'+p.properties.raw+'" rel\x3d"'+p.properties.position+'"\x3e'+w+C+"\x3c/div\x3e\x3c/td\x3e";r[ROWS]&&(d+=genTotalDataCells(E+1,x,u[ROWS],z[ROWS],r))}}d+="\x3c/tr\x3e";g="";r[COLUMNS]&&0<=x&&(g+=genTotalHeaderRowCells(x+1,u,z,r));y&&q?n<=q?(c+=d,0<g.length&&(c+=g)):(v.push(d),0<g.length&&v.push(g)):(c+=d,0<g.length&&(c+=g))}b&&(b.batchResult=v,b.hasBatchResult=0<v.length);return"\x3ctable\x3e"+c+"\x3c/table\x3e"};
...
SaikuChartRenderer.prototype.process_data_tree=function(a,b,c){var d={};b&&(d.resultset=[],d.metadata=[],d.height=0,d.width=0);var e=d;if("undefined"!=typeof a&&"undefined"!=typeof a.data&&!(null!==a.data&&null!==a.data.error||null===a.data||a.data.cellset&&0===a.data.cellset.length)){var f=a.data.cellset;if(f&&0<f.length){var g=0,l=0,h=!1,k,s,m,A=function(a,b){return a+b};k=0;for(s=f.length;0===l&&k<s;k++)for(var q=0,y=f[k].length;q<y;q++){if(!h)for(;"COLUMN_HEADER"==f[k][q].type&&"null"==f[k][q].value;)k++;
h=!0;if("ROW_HEADER_HEADER"==f[k][q].type){for(;"ROW_HEADER_HEADER"==f[k][q].type;)b&&d.metadata.push({colIndex:q,colType:"String",colName:f[k][q].value}),q++;g=q-1}if("COLUMN_HEADER"==f[k][q].type){l=0;for(m=[];l<=k;)"null"!==f[l][q].value&&m.push(f[l][q].value),l++;b&&d.metadata.push({colIndex:q,colType:"Numeric",colName:m.join(" ~ ")});l=k+1}}h=[];for(m=0;m<=g;m++)h.push(null);k=l;for(s=f.length;k<s;k++)if(""!==f[k][0].value){y=[];m=[];q=l=null;for(m=0;m<=g;m++){if(f[k]&&"null"===f[k][m].value){for(var e=
d,v=0;v<g&&"null"===f[k][v].value;v++)e=e[h[v]];v>m&&(m=v)}if(f[k]&&"null"!==f[k][m].value){if(0===m)for(v=0;v<=g;v++)h[v]=null;"number"==typeof e&&(l[q]={},e=l[q]);q=f[k][m].value;h[m]=q;e.hasOwnProperty(q)||(e[q]={});l=e;e=e[q]}}m=_.clone(h);e=g+1;for(v=f[k].length;e<v;e++){var r=f[k][e],u=r.value||0,z=0!==u,n=r.properties.raw;n&&"null"!==n?u=parseFloat(n):"number"!==typeof r.value&&parseFloat(r.value.replace(/[^a-zA-Z 0-9.]+/g,""))&&(u=parseFloat(r.value.replace(/[^a-zA-Z 0-9.]+/g,"")),z=!1);0<
u&&z&&(u=r.value&&0<=r.value.indexOf("%")?100*u:u);y.push(u);m.push({f:r.value,v:u})}b&&d.resultset.push(m);e=_.reduce(y,A,0);q=null===q?"null":q;l[q]=e;e=d}c&&(this.rawdata=a.data,this.data=d,this.hasProcessed=!0,this.data.height=this.data.resultset.length);return d}$(this.el).find(".canvas_wrapper").text("No results").show()}};
...
return!1}}),Upgrade=Backbone.View.extend({tagName:"div",events:{},initialize:function(a,b){this.workspace=a.workspace},daydiff:function(a,b){return Math.round((b-a)/864E5)},render:function(){var a=this,b=new License;Settings.BIPLUGIN5?b.fetch_license("api/api/license",function(b){if("error"!==b.status&&"trial"!=b.data.get("licenseType"))return this;"error"!==b.status&&"trial"===b.data.get("licenseType")?(b=parseFloat(b.data.get("expiration")),a.remainingdays=a.daydiff(new Date,new Date(b)),$(a.workspace.el).find(".upgrade").append("\x3cdiv\x3e\x3cdiv id\x3d'uphead' class\x3d'upgradeheader'\x3eYou are using a Saiku Enterprise Trial license, you have "+
a.remainingdays+" days remaining until the license expires.\x3c/div\x3e")):$(a.workspace.el).find(".upgrade").append("\x3cdiv\x3e\x3cdiv id\x3d'uphead' class\x3d'upgradeheader'\x3eYou are using Saiku Community Edition, please consider upgrading to \x3ca target\x3d'_blank' href\x3d'http://meteorite.bi'\x3eSaiku Enterprise, or entering a sponsorship agreement with us\x3c/a\x3e to support development. \x3ca href\x3d'mailto:info@meteorite.bi?subject\x3dSupporting Saiku'\x3einfo@meteorite.bi\x3c/a\x3e\x3c/div\x3e\x3c/div\x3e");
return a}):b.fetch_license("api/license/",function(b){if("error"!==b.status&&"trial"!=b.data.get("licenseType"))return this;"error"!==b.status&&"trial"===b.data.get("licenseType")?(b=parseFloat(b.data.get("expiration")),a.remainingdays=a.daydiff(new Date,new Date(b)),$(a.workspace.el).find(".upgrade").append("\x3cdiv\x3e\x3cdiv id\x3d'uphead' class\x3d'upgradeheader'\x3eYou are using a Saiku Enterprise Trial license, you have "+a.remainingdays+" days remaining until the license expires.\x3c/div\x3e")):
$(a.workspace.el).find(".upgrade").append("\x3cdiv\x3e\x3cdiv id\x3d'uphead' class\x3d'upgradeheader'\x3eYou are using Saiku Community Edition, please consider upgrading to \x3ca target\x3d'_blank' href\x3d'http://meteorite.bi'\x3eSaiku Enterprise, or entering a sponsorship agreement with us\x3c/a\x3e to support development. \x3ca href\x3d'mailto:info@meteorite.bi?subject\x3dSupporting Saiku'\x3einfo@meteorite.bi\x3c/a\x3e\x3c/div\x3e\x3c/div\x3e");return a})},call:function(a){}}),Modal=Backbone.View.extend({tagName:"div",
...
$(this.el).find("#password").val();$(this.el).dialog("close");this.session.login(a,b,$(this.el));return!0},setMessage:function(a){this.$el.find(".dialog_body").html(this.message)},setError:function(a){$(this.el).find(".dialog_response").html(a)},show_panel_user:function(a){a.preventDefault();$(a.currentTarget).next().slideToggle("fast")}}),AboutModal=Modal.extend({initialize:function(){_.extend(this.options,{title:"About "+Settings.VERSION})},events:{"click a":"close"},dummy:function(){return!0},
type:"info",message:Settings.VERSION+"\x3cbr\x3e\x3ca  target\x3d'_blank' href\x3d'http://www.analytical-labs.com'\x3ehttp://www.analytical-labs.com/\x3c/a\x3e\x3cbr\x3e\x3cbr\x3ePowered by \x3cimg width\x3d'20px' src\x3d'images/src/meteorite_free.png'  /\x3e \x3ca target\x3d'_blank' href\x3d'http://meteorite.bi'\x3ehttp://meteorite.bi/\x3c/a\x3e "}),OverwriteModal=Modal.extend({initialize:function(a){_.extend(this.options,{title:"Warning "});this.queryname=a.name;this.queryfolder=a.foldername;this.parentobj=
a.parent},buttons:[{text:"Yes",method:"save"},{text:"No",method:"close"}],dummy:function(){return!0},type:"info",message:"Are you sure you want to overwrite the existing query?",save:function(){this.parentobj.save_remote(this.queryname,this.queryfolder,this.parentobj);this.close();this.parentobj.close()},close:function(){$(this.el).dialog("destroy").remove();$(this.el).remove();return!1}}),AddFolderModal=Modal.extend({type:"save",closeText:"Save",events:{"click .form_button":"save","submit form":"save"},
buttons:[{text:"OK",method:"save"}],initialize:function(a){this.success=a.success;this.path=a.path;this.message="\x3cform id\x3d'add_folder'\x3e\x3clabel class\x3d'i18n' for\x3d'name'\x3eTo add a new folder, please type a name in the text box below:\x3c/label\x3e\x3cinput type\x3d'text' class\x3d'newfolder' name\x3d'name' /\x3e\x3c/form\x3e";_.extend(this.options,{title:"Add Folder"});if(isIE&&9>isIE)$(this.el).find("form").on("submit",this.save)},save:function(a){a.preventDefault();a=$(this.el).find('input[name\x3d"name"]').val();
(new SavedQuery({file:this.path+a,name:a})).save({},{success:this.success,dataType:"text",error:this.error});this.close();return!1},error:function(){$(this.el).find("dialog_body").html("Could not add new folder")}}),FilterModal=Modal.extend({type:"filter",closeText:"Save",events:{"submit form":"save","click .dialog_footer a":"call"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"}],message:"",expression_text:function(){var a="\x3cform id\x3d'custom_filter'\x3e\x3ctable border\x3d'0px'\x3e";
"Order"==this.expressionType&&(a+="\x3ctr\x3e\x3ctd class\x3d'col1'\x3eSort Type: \x3cselect id\x3d'fun'\x3e\x3coption\x3eASC\x3c/option\x3e\x3coption\x3eBASC\x3c/option\x3e\x3coption\x3eDESC\x3c/option\x3e\x3coption\x3eBDESC\x3c/option\x3e \x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e");return a+="\x3ctr\x3e\x3ctd class\x3d'col1'\x3e"+this.expressionType+" MDX Expression:\x3c/td\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd class\x3d'col1'\x3e\x3ctextarea class\x3d'filter_expression'\x3e\x3c/textarea\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/form\x3e"},
...
function(){var b=a.editor.getValue(),c=[];if(b)for(var f=0,g=b.length;f<g-1;f++)if("$"===b[f]&&"{"===b[f+1]){for(var l="",h=!1,f=f+2;f<g;f++)if("}"!==b[f])l+=b[f];else{h=!0;f++;break}h&&l&&0<l.length&&c.push(l)}var k=a.workspace.query.helper.model().parameters,s={};_.each(c,function(a){s[a]=k[a]?k[a]:""});a.workspace.query.helper.model().parameters=s;a.workspace.update_parameters()},b=function(){_.delay(c,1E3)};a.editor&&(a.editor.getSession().off("change",b),a.editor.getSession().on("change",b));
...
"").split(".")[0],f=c.text(),f=this.find_type_time(d,e,f),g=c.attr("hierarchy"),l=c.attr("href").replace("#","");void 0===f.level.annotations||null===f.level.annotations||void 0===f.level.annotations.AnalyzerDateFormat&&void 0===f.level.annotations.SaikuDayFormatString?(new SelectionsModal({target:c,name:c.text(),key:l,workspace:this.workspace})).open():(new DateFilterModal({dimension:d,hierarchy:e,name:c.text(),data:f,analyzerDateFormat:f.level.annotations.AnalyzerDateFormat,dimHier:g,key:l,workspace:this.workspace})).open();
return!1},measure_action:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;a=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent();var c={HEADER:{name:"Position",disabled:!0,i18n:!0},sep1:"---------",BOTTOM_COLUMNS:{name:"Columns | Measures",i18n:!0},TOP_COLUMNS:{name:"Measures | Columns",i18n:!0},BOTTOM_ROWS:{name:"Rows | Measures",i18n:!0},TOP_ROWS:{name:"Measures | Rows",i18n:!0},sep2:"---------",
reset:{name:"Reset Default",i18n:!0},cancel:{name:"Cancel",i18n:!0}};$.each(c,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});$.contextMenu("destroy",".limit");$.contextMenu({appendTo:a,selector:".limit",ignoreRightClick:!0,build:function(a,e){var f=b.workspace.query;return{callback:function(a,b){var c=f.helper.model().queryModel.details;if("cancel"!==a){if("reset"===a)c.location=SaikuOlapQueryTemplate.queryModel.details.location,c.axis=SaikuOlapQueryTemplate.queryModel.details.axis;
else{var d=a.split("_")[0],e=a.split("_")[1];c.location=d;c.axis=e}f.run()}},items:c}}});a.contextMenu()},limit_axis:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;var c=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent(),d=c.siblings(".fields_list_body").parent().attr("title");$.contextMenu("destroy",".limit");$.contextMenu({appendTo:c,selector:".limit",ignoreRightClick:!0,build:function(a,
f){var g={},l=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,h=b.workspace.query.helper.getAxis(d),k,s,m,A,q,y,v,r,u,z=!1,n=!1,w=!1;h&&h.filters&&_.each(h.filters,function(a){"N"==a.flavour&&(k=h["function"],s=a.expressions[0],m=a.expressions[1],w=!0);"Generic"==a.flavour&&(A=a.expressions[0],z=!0)});h&&h.sortOrder&&(q=h.sortOrder,y=h.sortEvaluationLiteral,n=!0);h&&h.aggregators&&0<h.aggregators.length&&(u=h.aggregators[0]);null!==k&&null===m?r=k+"###SEPARATOR###"+
s:null!==k&&null!==m&&null!==s&&(r="custom");n&&null!==q&&(v="customsort");_.each(l,function(a){g[a.uniqueName]={name:a.caption,payload:{n:10,sortliteral:a.uniqueName}}});var F=[];_.each(h.hierarchies,function(a){for(var b in a.levels){console.log(b);var c="",c=null!=a.levels[b].caption?a.levels[b].caption:a.levels[b].name;F[a.levels[b].name]={name:c}}});var x=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),c[b+"###SEPARATOR###"+d].fun=b,b==k&&m==d&&a[d].payload.n==s&&(r=
b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e"),b==q&&y==d&&(v=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},x={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},clearfilter:{name:"Clear Filter",i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",i18n:!0},TopCountQuick:{name:"Top 10 by...",i18n:!0,items:x(g,"TopCount")},
BottomCountQuick:{name:"Bottom 10 by...",i18n:!0,items:x(g,"BottomCount")},customtop:{name:"Custom Limit...",i18n:!0},clearlimit:{name:"Clear Limit",i18n:!0}}},sort:{name:"Sort",i18n:!0,items:{ASCQuick:{name:"Ascending",i18n:!0,items:x(g,"ASC")},DESCQuick:{name:"Descending",i18n:!0,items:x(g,"DESC")},BASCQuick:{name:"Ascending (Breaking Hierarchy)",i18n:!0,items:x(g,"BASC")},BDESCQuick:{name:"Descending (Breaking Hierarchy)",i18n:!0,items:x(g,"BDESC")},customsort:{name:"Custom...",i18n:!0},clearsort:{name:"Clear Sort",
i18n:!0}}},grand_totals:{name:"Grand totals",i18n:!0,items:{show_totals_not:{name:"None",i18n:!0},show_totals_sum:{name:"Sum",i18n:!0},show_totals_min:{name:"Min",i18n:!0},show_totals_max:{name:"Max",i18n:!0},show_totals_avg:{name:"Avg",i18n:!0}}},parameters:{name:"Parameters",i18n:!0,items:{ParamQuick:{name:"Add Parameter",i18n:!0,items:x(F,"Param")},ParamRemove:{name:"Remove Parameter",i18n:!0,items:x(null,"Param")}}},cancel:{name:"Cancel",i18n:!0}};$.each(x,function(a,b){recursive_menu_translate(b,
Saiku.i18n.po_file)});var D=x.grand_totals.items;if(u)for(var t in D)t.substring(12)==u&&(D[t].name="\x3cb\x3e"+D[t].name+"\x3c/b");else D.show_totals_not.name="\x3cb\x3e"+D.show_totals_not.name+"\x3c/b";g["10"]={payload:{n:10}};z&&(u=x.filter,u.name="\x3cb\x3e"+u.name+"\x3c/b\x3e",u.items.customfilter.name="\x3cb\x3e"+u.items.customfilter.name+"\x3c/b\x3e");n&&(n=x.sort.items,x.sort.name="\x3cb\x3e"+x.sort.name+"\x3c/b\x3e",v in n&&(n[v].name="\x3cb\x3e"+n[v].name+"\x3c/b\x3e"));w&&(n=x.limit.items,
x.limit.name="\x3cb\x3e"+x.limit.name+"\x3c/b\x3e",r in n&&(n[r].name="\x3cb\x3e"+n[r].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(h,"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(h,"Generic");h.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:c});b.synchronize_query();
b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:A,expressionType:"Filter"})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(h,"N"),b.synchronize_query(),b.workspace.query.run();else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(h,"N");h.filters.push({flavour:"N",operator:null,"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},
(new CustomFilterModal({axis:d,measures:l,success:f,query:b.workspace.query,func:k,n:s,sortliteral:m})).render().open();else if("customsort"==a)f=function(a,c){h.sortOrder=a;h.sortEvaluationLiteral=c;b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:y,expressionType:"Order"})).render().open();else{if("clearsort"==a)h.sortOrder=null,h.sortEvaluationLiteral=null,alert("maybe?"),b.synchronize_query();else if(0===a.indexOf("show_totals_")){f=
a.substring(12);var n=[];n.push(f);h.aggregators=n}else{f=a.split("###SEPARATOR###")[0];var r=a.split("###SEPARATOR###")[1];-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f)?(h.sortOrder=f,h.sortEvaluationLiteral=g[r].payload.sortliteral):-1<_.indexOf(["Param"],f)?(console.log("here"),h.sortEvaluationLiteral=g[r].payload.sortliteral):(n=[],n.push(g[r].payload.n),(r=g[r].payload.sortliteral)&&n.push(r),b.workspace.query.helper.removeFilter(h,"N"),h.filters.push({flavour:"N",operator:null,"function":f,
expressions:n}));b.synchronize_query()}b.workspace.query.run()}},items:x}}});c.contextMenu()}}),Table=Backbone.View.extend({className:"table_wrapper",events:{"click th.row":"clicked_cell","click th.col":"clicked_cell"},initialize:function(a){this.workspace=a.workspace;this.renderer=new SaikuTableRenderer;_.bindAll(this,"render","process_data");this.workspace.bind("query:result",this.render);this.id=_.uniqueId("table_");$(this.el).attr("id",this.id)},clicked_cell:function(a){return!1},render:function(a,
b){"undefined"==typeof a||"undefined"==typeof a.data||$(this.workspace.el).is(":visible")&&!$(this.el).is(":visible")||null!==a.data&&null!==a.data.error||null===a.data||a.data.height&&0===a.data.height||(this.clearOut(),$(this.el).html("Rendering "+a.data.width+" columns and "+a.data.height+" rows..."),_.delay(this.process_data,2,a.data))},clearOut:function(){this.renderer.clear();$(this.workspace.el).find(".workspace_results").unbind("scroll");var a=document.getElementById(this.id),b=a.firstChild;
b&&a.removeChild(b)},process_data:function(a){this.workspace.processing.hide();this.workspace.adjust();this.clearOut();$(this.el).html("\x3ctable\x3e\x3c/table\x3e");this.renderer.render(a,{htmlObject:$(this.el).find("table"),batch:Settings.TABLE_LAZY,batchSize:Settings.TABLE_LAZY_SIZE,batchIntervalSize:Settings.TABLE_LAZY_LOAD_ITEMS,batchIntervalTime:Settings.TABLE_LAZY_LOAD_TIME});this.post_process()},post_process:function(){"QM"==this.workspace.query.get("type")&&"view"!=Settings.MODE?$(this.el).addClass("headerhighlight"):
...
"prepare","new_query","init_query","update_caption","populate_selections","refresh","sync_query","cancel","cancelled","no_results","error","switch_view_state");_.extend(this,Backbone.Events);this.loaded=!1;this.bind("query:result",this.render_result);this.toolbar=new WorkspaceToolbar({workspace:this});this.toolbar.render();this.upgrade=new Upgrade({workspace:this});this.upgrade.render();this.querytoolbar=new QueryToolbar({workspace:this});this.querytoolbar.render();this.drop_zones=new WorkspaceDropZone({workspace:this});
this.drop_zones.render();this.table=new Table({workspace:this});this.chart=new Chart({workspace:this});this.dateFilter=new DateFilterCollection;this.item={};this.viewState=a&&a.viewState?a.viewState:Settings.DEFAULT_VIEW_STATE;this.isReadOnly="view"==Settings.MODE||!1;a&&a.item&&(this.item=a.item)&&this.item.hasOwnProperty("acl")&&0>_.indexOf(this.item.acl,"WRITE")&&(this.isReadOnly=!0,this.viewState="view");a&&(a.query||a.viewState)||(this.viewState="edit");a&&a.query&&(this.query=a.query,this.query.workspace=
this,this.query.save({},{success:this.init_query,error:function(){Saiku.ui.unblock();if(1>$("body").find(".error_loading_query").length){var a=Saiku.i18n&&Saiku.i18n.po_file.error_loading_query?Saiku.i18n.po_file.error_loading_query:null;a||($('\x3cspan class\x3d"i18n error_loading_query"\x3eError Loading Query\x3c/span\x3e').hide().appendTo("body"),Saiku.i18n.translate(),a=$(".error_loading_query").text())}else a=$(".error_loading_query").text();alert(a)}}));Saiku.session.bind("tab:add",this.prepare);
a=Saiku.URLParams.paramsURI();Saiku.URLParams.equals({schema:a.schema,cube:a.cube});this.data_connections(a)},caption:function(a){if(this.query&&this.query.model){if(this.item&&this.item.name)return this.item.name.split(".")[0];if(this.query.model.mdx)return this.query.model.name}else if(this.query&&this.query.get("name"))return this.query.get("name");a&&Saiku.tabs.queryCount++;return"\x3cspan class\x3d'i18n'\x3eUnsaved query\x3c/span\x3e ("+Saiku.tabs.queryCount+")"},selected_cube_template:function(a){var b=
...
a){this.workspace.unblock();$(this.workspace.el).find(".workspace_results_info").empty();this.workspace.trigger("query:run");this.result.result=null;var d=!1,e="Query Validation failed!",f=this.helper.model();if("OLAP"==f.queryType)if("QUERYMODEL"==f.type){var g=0<Object.keys(f.queryModel.axes.COLUMNS.hierarchies).length,l=0<Object.keys(f.queryModel.axes.ROWS.hierarchies).length,h="COLUMNS"==f.queryModel.details.axis&&0<f.queryModel.details.measures.length;l&&g&&h||(e="");g||h||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one measure or a level on columns for a valid query.\x3c/span\x3e');
l||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one level on rows for a valid query.\x3c/span\x3e');(g||h)&&l&&(d=!0)}else"MDX"==f.type&&((d=f.mdx&&0<f.mdx.length)||(e='\x3cspan class\x3d"i18n"\x3eYou need to enter some MDX statement to execute.\x3c/span\x3e'));d?(this.workspace.table.clearOut(),$(this.workspace.processing).html('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eRunning query...\x3c/span\x3e [\x26nbsp;\x3ca class\x3d"cancel i18n" href\x3d"#cancel"\x3eCancel\x3c/a\x3e\x26nbsp;]').show(),
...
b;a++)for(var c=this.connections[a],d=0,e=c.catalogs.length;d<e;d++)for(var f=c.catalogs[d],g=0,l=f.schemas.length;g<l;g++)for(var h=f.schemas[g],k=0,s=h.cubes.length;k<s;k++){var m=c.name+"/"+f.name+"/"+(""===h.name||null===h.name?"null":h.name)+"/"+encodeURIComponent(h.cubes[k].name);"undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+m)?this.cube[m]=new Cube(JSON.parse(localStorage.getItem("cube."+m))):(this.cube[m]=new Cube({key:m}),!0===Settings.DIMENSION_PREFETCH&&
...
$(this.el).find(".dialog_body").prepend(a);var b=this,c,d,e,f,g=null,l={};if(null===b.hierarchy||void 0===b.hierarchy)b.hierarchy=b.dimension;this.$el.find(".available-selections").each(function(a,h){if("true"===$(h).attr("available")){l.type=$(h).attr("selection-name");"operator"===$(h).attr("selection-name")?$(h).find("input:radio").each(function(a,e){if(!0===$(e).is(":checked")){var f=$(e).data("operator");l.checked=$(e).attr("id");if("after"===f||"after\x26equals"===f||"before"===f||"before\x26equals"===
f)b.selectedDates=[],b.selectedDates.push(b.$el.find("#selection-date").val());else if("between"===f||"notbetween"===f)b.selectedDates=[],b.selectedDates.push(b.$el.find("#start-date").val()),b.selectedDates.push(b.$el.find("#end-date").val());c="dayperiods";d=$(e).val();l.values=b.selectedDates}}):"fixed-date"===$(h).attr("selection-name")?$(h).find("input:radio").each(function(a,b){!0===$(b).is(":checked")&&(c=$(b).attr("id").split("-")[1],e=$(b).val(),l.checked=$(b).attr("id"))}):"rolling-date"===
$(h).attr("selection-name")&&(e=$("#period-select").find(":selected").val(),c="lastperiods",f=$(h).find("input:text").val(),l.fixedDateName=c,l.periodAmount=$(h).find("input:text").val(),l.periodSelect=$("#period-select").find(":selected").attr("id"));var k=b.dataLevels.length,q,y;for(y=0;y<k;y++)b.dataLevels[y].analyzerDateFormat===e&&(q=b.dataLevels[y].name);k={dimension:b.dimension,hierarchy:b.hierarchy,level:b.name,analyzerDateFormat:e,periodAmount:f,comparisonOperator:d,workinglevel:q};g="dayperiods"===
c&&""!==b.selectedDates[0]&&void 0!==b.selectedDates[0]||"lastperiods"===c&&!_.isEmpty(e)&&"Day(s)"!==e&&!_.isEmpty(f)||"dayperiods"!==c&&"lastperiods"!==c&&!_.isEmpty(e)?b.populate_mdx(k,c):null}});var h=decodeURIComponent(this.member.hierarchy);a=decodeURIComponent(this.member.level);h=this.workspace.query.helper.getHierarchy(h);this.get_cube_name();_.extend(l,this.levelInfo);if("dayperiods"===c&&""!==this.selectedDates[0]&&void 0!==b.selectedDates[0]||"lastperiods"===c&&!_.isEmpty(e)&&"Day(s)"!==
e&&!_.isEmpty(f)||"dayperiods"!==c&&"lastperiods"!==c&&!_.isEmpty(e))this.set_date_filter(l);else{var k=this.get_uuid(l);this.workspace.dateFilter.remove(k)}h&&h.levels.hasOwnProperty(a)&&(h.levels[a]={mdx:g,name:a});this.finished()},get_cube_name:function(){return decodeURIComponent(this.workspace.selected_cube.split("/")[3])},get_uuid:function(a){return"["+a.cube+"]."+this.dimHier+".["+a.name+"]"},set_date_filter:function(a){var b=this.workspace.dateFilter,c=b.toJSON(),d=this.get_uuid(a);a.id=d;
a.key=this.key;c&&!_.isEmpty(c)?b.get(d)?(b=b.get(d),b.set(a)):b.add(a):b.add(a)},get_date_filter:function(){var a={cube:this.get_cube_name(),dimension:this.dimension,hierarchy:this.hierarchy,name:this.name},a=this.get_uuid(a);return a=(a=this.workspace.dateFilter.get(a))?a.toJSON():[]},clear_date_filter:function(a){a.preventDefault();this.workspace.dateFilter.toJSON();var b;b=this.get_uuid(this.levelInfo);var c=decodeURIComponent(this.member.hierarchy),d=decodeURIComponent(this.member.level);(c=
this.workspace.query.helper.getHierarchy(c))&&c.levels.hasOwnProperty(d)&&(c.levels[d]={mdx:null,name:d});this.workspace.dateFilter.remove(b);this.clear_selections(a);this.finished()},show_button_clear:function(){var a=this.workspace.dateFilter,b=a.toJSON(),c;c=this.get_uuid(this.levelInfo);return b&&!_.isEmpty(b)?a.get(c)?!0:!1:!1},finished:function(a){this.$el.dialog("destroy").remove();a||this.query.run()}}),DateFilterObserver=Backbone.View.extend({initialize:function(a){this.workspace=a.workspace;
_.bindAll(this,"receive_data","workspace_levels");this.workspace.bind("query:result",this.receive_data);Saiku.session.bind("dimensionList:select_dimension",this.receive_data);Saiku.session.bind("workspaceDropZone:select_dimension",this.receive_data);Saiku.session.bind("workspaceDropZone:clear_axis",this.receive_data)},receive_data:function(a){var b=this.workspace.dateFilter.toJSON();this.workspace.$el.find(".dateFilterObserver").addClass("disabled_toolbar");if(b&&!_.isEmpty(b))return this.workspace.$el.find(".dateFilterObserver").removeClass("disabled_toolbar"),
_.delay(this.workspace_levels,1E3,a);this.workspace.$el.find(".dateFilterObserver").addClass("disabled_toolbar")},get_cube_name:function(){return decodeURIComponent(this.workspace.selected_cube.split("/")[3])},workspace_levels:function(a){a=this.get_cube_name();var b=this.workspace.query.helper.getAxis("COLUMNS"),c=this.workspace.query.helper.getAxis("ROWS"),d=this.workspace.query.helper.getAxis("FILTER"),e=[];"COLUMNS"===b.location&&0<b.hierarchies.length&&e.push(this.get_axes(a,b));"ROWS"===c.location&&
0<c.hierarchies.length&&e.push(this.get_axes(a,c));"FILTER"===d.location&&0<d.hierarchies.length&&e.push(this.get_axes(a,d));e=_.compact(_.union(e[0],e[1],e[2]));this.check_dateFilter_model(e)},get_axes:function(a,b){var c=[],d=b.hierarchies.length,e;for(e=0;e<d;e++)for(var f in b.hierarchies[e].levels)b.hierarchies[e].levels.hasOwnProperty(f)&&c.push("["+a+"]."+b.hierarchies[e].name+".["+f+"]");return c},check_dateFilter_model:function(a){var b=[],c=[],d=this.workspace.dateFilter.toJSON(),e=d.length,
f=a.length,g=0,l=0;if(0<f&&d&&!_.isEmpty(d))for(;l<f;)a[l]===d[g].id?c.push(d[g].id):b.push(d[g].id),g+1<e?g++:(g=0,l++);else if(0===f&&d&&!_.isEmpty(d))for(a=0;a<e;a++)this.workspace.$el.find(".dateFilterObserver").addClass("disabled_toolbar"),this.workspace.dateFilter.remove(d[a].id);this.remove_dateFilter_model(_.difference(b,c))},remove_dateFilter_model:function(a){var b=a.length,c;for(c=0;c<b;c++)this.workspace.dateFilter.remove(a[c])}});
...
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,g,l,h,k,s=0,m=a.length,A=Math.max,q="";s<m;){c=a.charCodeAt(s++)||0;f=a.charCodeAt(s++)||0;k=a.charCodeAt(s++)||0;if(255<A(c,f,k))throw b;g=c>>2&63;c=(c&3)<<4|f>>4&15;l=(f&15)<<2|k>>6&3;h=k&63;f?k||(h=64):l=h=64;q+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(g)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(l)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h)}return q}})})(this);
