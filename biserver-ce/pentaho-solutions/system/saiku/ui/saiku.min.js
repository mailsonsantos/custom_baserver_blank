...
a.remainingdays+" days remaining until the license expires.\x3c/div\x3e")):$(a.workspace.el).find(".upgrade").append("");
return a}):b.fetch_license("api/license/",function(b){if("error"!==b.status&&"trial"!=b.data.get("licenseType"))return this;"error"!==b.status&&"trial"===b.data.get("licenseType")?(b=parseFloat(b.data.get("expiration")),a.remainingdays=a.daydiff(new Date,new Date(b)),$(a.workspace.el).find(".upgrade").append("")):
